...
export const BrainIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M17.1,7.2C16.2,6,15.1,5,13.6,5c-0.5,0-1,0.1-1.5,0.2c-1.3-1.6-3.4-2.8-5.8-2.8C3.5,2.4,1,5.2,1,8.5c0,2.1,1,3.9,2.6,5.2 c-0.2,0.8-0.3,1.6-0.3,2.4c0,3.3,2.7,6,6,6c1.1,0,2.1-0.3,3-0.8c0.8,1.2,2.1,2,3.6,2c2.8,0,5.1-2.3,5.1-5.1 C21.9,14.5,19.9,10.2,17.1,7.2z M13.6,6.3c1,0,1.8,0.7,2.3,1.6c-1,0.6-2,1.3-2.9,2.2c-0.6-0.1-1.2-0.2-1.8-0.2 c0-1.2,0.2-2.3,0.6-3.4C12.3,6.4,12.9,6.3,13.6,6.3z M6.3,3.7c1.8,0,3.4,0.9,4.4,2.2c-0.4,1-0.6,2.2-0.6,3.4 c-0.6,0-1.2,0.1-1.8,0.2c-0.9-0.9-1.9-1.6-2.9-2.2C5.5,6.5,5.6,5.1,6.3,3.7z M2.3,8.5c0-2.6,2.1-4.8,4-4.8c-0.5,1.3-0.5,2.6,0,3.9 C4.2,8,2.3,8.2,2.3,8.5z M9.3,20.8c-2.6,0-4.7-2.1-4.7-4.7c0-0.7,0.1-1.3,0.4-1.9c1,0.5,2.1,0.8,3.2,0.8c1.3,0,2.6-0.4,3.7-1.1 C11.5,17,10.6,19.2,9.3,20.8z M18.4,18.8c-1.3,1.3-3,2-4.8,2c-1,0-1.9-0.3-2.7-0.8c1.3-1.6,2-3.8,2-6c0-1.2-0.2-2.4-0.6-3.5 c0.6,0,1.2-0.1,1.8-0.1c1.5,0,2.9,0.7,3.9,1.8C20.3,13.7,19.7,17.5,18.4,18.8z" />
  </svg>
);
...
export const DocumentChartBarIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 17v-4m3 4v-2m3 2v-6m-9 8h12a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2z" />
    </svg>
);

export const IdentificationIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 012-2h4a2 2 0 012 2v1m-4 0h4m-9 4h2m-2 4h4m5-4h2m-2 4h4" />
    </svg>
);
...
export const TruckIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10l2 2h8l2-2H5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M17 16h2a1 1 0 001-1V7a1 1 0 00-1-1h-2" />
    </svg>
);
...
export const ArrowPathRoundedSquareIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const BuildingLibraryIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const ServerStackIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const LayoutIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" />
    </svg>
);
